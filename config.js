...
window.SITE_CONFIG = {
  ...
  contact: {
    ...
    cv: {
      title: 'Resume / CV',
      filename: 'alex-carter-cv.pdf',
      fileMeta: 'alex-carter-cv.pdf · ~42 KB',
      buttonText: 'Download CV',
      content: [
        '%PDF-1.4',
        '% Alex Carter — Resume / CV (placeholder)',
        '',
        'ALEX CARTER',
        'Full-Stack Engineer',
        'Milan, Italy · Remote',
        'alex.carter@example.com · github.com/alex-carter · linkedin.com/in/alex-carter',
        '',
        'SUMMARY',
        ...
        '',
        'EDUCATION',
        '  M.Sc. Computer Science — Politecnico di Milano (2018)',
        '',
